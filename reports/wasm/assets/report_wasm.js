 ...
 * @returns {string}
 */
export function get_dot_string(json_data, dark_mode) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.get_dot_string(retptr, ptr0, len0, dark_mode);
 ...
 * @returns {string}
 */
export function graph_to_dot(json_data, dark_mode) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
export function render_graph_svg(json_data, dark_mode) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(json_data, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        const len0 = WASM_VECTOR_LEN;
        wasm.render_graph_svg(retptr, ptr0, len0, dark_mode);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('report_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
